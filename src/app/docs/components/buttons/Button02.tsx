...
function ButtonComp() {
  return (
    <div className="w-full h-full bg-secondary/10 flex flex-col justify-center items-center gap-4">
      <button className="px-5 py-2 rounded-lg text-white font-medium bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 hover:scale-105 transition">
        Gradient Button
      </button>
    </div>
  );
